...
data_dir <- "https://raw.githubusercontent.com/semihozankaya/CEU-Business-Analytics-2020/master/Data_Analysis1/TeamAssignment_Eszter_Ozan_Viki/da1_data.csv"
pizza <- read.csv(data_dir)
pizza_summary <- pizza %>% 
